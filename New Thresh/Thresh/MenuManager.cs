...
namespace Thresh
{
    public static class MenuManager
    {
        ...
        public static void Init(EventArgs args)
        {
            ...
            SubMenu["Prediction"] = AddonMenu.AddSubMenu("Prediction 2.0", "Prediction 2.0");
            SubMenu["Prediction"].AddGroupLabel("Q Config");
            ...
            SubMenu["Prediction"].AddGroupLabel("E Config");
            ...
            SubMenu["Prediction"].Add("Q", new CheckBox("Use Q Dash"));
            SubMenu["Prediction"].Add("E", new CheckBox("Use E Flash"));
            SubMenu["Prediction"].Add("Q2", new CheckBox("Use Q fash"));
            SubMenu["Prediction"].Add("R", new CheckBox("Use R Harass"));
            SubMenu["Prediction"].Add("Prediction", new CheckBox("Use ICPrediction?"));
            ...
            SubMenu["Harass"].AddStringList("Q1", "Use Q1", new[] {"Never", "Only on target", "On any enemy", "Enemy Dash"}, 1);
